...
def load_scene(assets, room=True):
    ...
    ET.SubElement(world, "geom", name="floor", type="plane", size="12 12 0.1", rgba="0.8 0.85 0.9 1")
    if room:
    ...
    ET.SubElement(xml.find("visual"), "global", offwidth="640", offheight="480")
